...
Module Variables
    ...
    Public cheminDossier As String = cheminBase & "SaisieJour\"
    Public cheminDossierFichier As String = cheminBase & "SaisieJour\" & "SaveSaisie.xls"
