...
Public Class Etiquette
    ...
    Public Sub New(ByVal numEtiq As String, ByVal numOF As String, ByVal numOP As String, ByVal numProd As String, ByVal nomProd As String, ByVal numMach As String, ByVal numPointage As String, ByVal dateScan As String, ByVal numLot As String, ByVal quantite As String)
        _numEtiq = numEtiq
        _numOF = numOF
        _numOP = numOP
        _numProd = numProd
