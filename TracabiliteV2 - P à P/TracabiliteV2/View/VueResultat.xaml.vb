Public Class VueResultat
    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        ...
        myListView.ItemsSource = listOfListOfEtiquette
    ...
    Private Sub Button_Click(sender As Object, e As RoutedEventArgs)
        Dim nameToCut As String = sender.Content
        etiqDetail = getinfoEtiquette(nameToCut)

        GridDetails.DataContext = etiqDetail
    ...
    Private Sub BMini_Click(sender As Object, e As RoutedEventArgs)
